...
public class ActionField extends JPanel {
	...
	private void processAction(Actions action, Tank tank) throws Exception {
		  ...
		  recordTanksMovements(action, tank);
	...
	private void recordTanksMovements(Actions action, Tank tank) throws FileNotFoundException, IOException, ClassNotFoundException {
		new GameplayRecord(tank, action);		
	}
