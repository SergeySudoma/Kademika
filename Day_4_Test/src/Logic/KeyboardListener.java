            	...
            	Thread moveLeftThread = new Thread(new Runnable() {
					...
					public void run() {
		                try {
							...
							af.syncronizedProcessAction(new ActionsPair(Actions.MOVE, Direction.LEFT), af.getDefender());
            	...
            	Thread moveRightThread = new Thread(new Runnable() {
					...
					public void run() {
		                try {
		                	...
		                	isMoving = true;
							af.syncronizedProcessAction(new ActionsPair(Actions.MOVE, Direction.RIGHT), af.getDefender());
            	...
            	Thread moveUpThread = new Thread(new Runnable() {
					...
					public void run() {
		                try {
		                	...
		                	isMoving = true;
							af.syncronizedProcessAction(new ActionsPair(Actions.MOVE, Direction.UP), af.getDefender());
            	...
            	Thread moveDownThread = new Thread(new Runnable() {
					...
					public void run() {
		                try {
		                	...
		                	isMoving = true;
							af.syncronizedProcessAction(new ActionsPair(Actions.MOVE, Direction.DOWN), af.getDefender());
		...
		af.getActionMap().put("fire", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	Thread fireThread = new Thread(new Runnable() {
					...
					public void run() {
		                try {
		                	af.syncronizedProcessAction(new ActionsPair(Actions.FIRE, af.getDefender().getDirection()), af.getDefender());
