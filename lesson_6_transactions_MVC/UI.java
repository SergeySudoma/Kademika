...
public class UI {
	...
	JButton buttonTodayTransactionsReport = new JButton("Report today transactions");
	gdc.fill = GridBagConstraints.LINE_START;
	gdc.gridy = 11;	
	panel.add(buttonTodayTransactionsReport, gdc);
	buttonTodayTransactionsReport.addActionListener(new ActionListener() {
	...
	private void createTodayTransactionReportPanel(){
		...
		reportFrame.getContentPane().add(new JScrollPane(table));
